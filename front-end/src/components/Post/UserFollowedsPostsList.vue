...
<script>
import Post from '../../../../../../Downloads/flask-vuejs-madblog-0.7/front-end/src/components/Base/Post'
import Pagination from '../../../../../../Downloads/flask-vuejs-madblog-0.7/front-end/src/components/Base/Pagination'
// bootstrap-markdown 编辑器依赖的 JS 文件，初始化编辑器在组件的 created() 方法中，同时它需要 JQuery 支持哦
import '../../../../../../Downloads/flask-vuejs-madblog-0.7/front-end/src/assets/bootstrap-markdown/js/bootstrap-markdown.js'
